/* $Id: FileFolderSelectionDialogBox.qml
                ...
                Rectangle{
                    ...
                    Row{
                        ...
                        RImageButton{
                            ...
                            height: parent.height
                            width: height
                            icon.source: "/local/assets/cd-up.svg"
                        ...
                        RImageButton{
                            ...
                            height: parent.height
                            width: height
                            icon.source: "/local/assets/hidden-" + (hidden ? "checked" :"unchecked.svg")
                            icon.color: rDialogBox.IconColor
                        ...
                        RImageButton{
                            ...
                            height: parent.height
                            width: height
                            icon.source: "/local/assets/" + (currentView ? "list" : "grid") + "view.svg"
                            icon.color: rDialogBox.IconColor
                        ...
                        RImageButton{
                            ...
                            height: parent.height
                            width: height
                            icon.source: "/local/assets/image-preview-" + (nowPreviewing ? "checked.svg" :"unchecked.svg")
                            icon.color: rDialogBox.IconColor
